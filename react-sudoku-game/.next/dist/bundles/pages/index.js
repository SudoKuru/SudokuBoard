...
var pages_Index = function (_Component2) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this2 = pages__possibleConstructorReturn(this, (_ref7 = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref7, [this].concat(args))), _this2), _this2.state = {}, _this2.generateGame = function () {
    ...
    }, _this2.addNumberAsNote = function (number) {
      var board = _this2.state.board;

      var selectedCell = _this2.getSelectedCell();
      ...
      if (currentValue) {
        board = updateBoardWithNumber({
          x: x, y: y, number: currentValue, fill: false, board: _this2.state.board
        });
      }
    ...
    }, _this2.updateBoard = function (newBoard) {
      var history = _this2.state.history;
      var historyOffSet = _this2.state.historyOffSet;
      ...
      // update the game
      _this2.setState({ board: newBoard, history: history, historyOffSet: history.size - 1 });
    }, _this2.canUndo = function () {
      return _this2.state.historyOffSet > 0;
      ...
      if (history.size) {
        ...
        _this2.setState({ board: board, historyOffSet: historyOffSet });
      }
    }, _this2.undo = function () {
      var history = _this2.state.history;
      var _this2$state = _this2.state,
          historyOffSet = _this2$state.historyOffSet,
          board = _this2$state.board;

      if (history.size) {
        historyOffSet = Math.max(0, historyOffSet - 1);
        board = history.get(historyOffSet);
        _this2.setState({ board: board, historyOffSet: historyOffSet, history: history });
      }
    }, _this2.eraseSelected = function () {
      var selectedCell = _this2.getSelectedCell();
      if (!selectedCell) return;
      _this2.fillNumber(false);
    }, _this2.fillSelectedWithSolution = function () {
      var _this2$state2 = _this2.state,
          board = _this2$state2.board,
          solution = _this2$state2.solution;
      ...
      _this2.fillNumber(solution[x][y]);
    }, _this2.fillNumber = function (number) {
      var board = _this2.state.board;
      ...
      return external__react__default.a.createElement(
        ...
        range(9).map(function (i) {
          ...
          var clickHandle = getClickHandler(function () {
            _this4.fillNumber(number);
          }, function () {
            _this4.addNumberAsNote(number);
          });
          return external__react__default.a.createElement(pages_NumberControl, {
            key: number,
            number: number,
            onClick: !prefilled ? clickHandle : undefined,
            completionPercentage: _this4.getNumberValueCount(number) / 9
          });
        }),
        external__react__default.a.createElement(style__default.a, {
          ...
          return (
            ...
            external__react__default.a.createElement(
              ...
              row.map(function (cell, j) {
                return _this5.renderCell(cell, i, j);
              }).toArray()
            )
          );
        }).toArray(),
    ...
    value: function renderHeader() {
      ...
      return external__react__default.a.createElement(
        ...
        external__react__default.a.createElement(
          'div',
          { onClick: function onClick() {
              return _this6.setState({ board: false });
